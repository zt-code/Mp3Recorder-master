...
public class MP3Recorder {
	...
	//public static String PATH = "/Android/data/com.hxx.light/files/cache";
...
//		} else {
//			// 录音可能被禁用了，做出适当的提示
//			Log.i(TAG,"录音可能被禁用了，做出适当的提示  ");
//			String[] per={Manifest.permission.RECORD_AUDIO};
//			PermissionUtils.addPermissions(AudioRecording.this,per);
//		}
	...
	private void initAudioRecorder() throws IOException {
		...
		LameUtil.init(samplingRate, 1, samplingRate, BIT_RATE,7);
...
//		SimpleLame.init(samplingRate, 1, samplingRate, BIT_RATE);
		...
		Log.i(TAG, "PATH："+directory.getAbsolutePath() + "/recording.mp3");*/
